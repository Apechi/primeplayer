...
import com.theprime.primegoplayer.databinding.FragmentAllMusicBinding
import com.theprime.primegoplayer.databinding.MusicItemBinding
import com.theprime.primegoplayer.extensions.setTitleColor
import com.theprime.primegoplayer.extensions.toFormattedDate
import com.theprime.primegoplayer.extensions.toFormattedDuration
    ...
    private fun finishSetup() {
        ...
        _allMusicFragmentBinding?.run {
            ...
            shuffleFab.setOnClickListener {
                ...
                AdsHelper.showInterstitialPrime(activity, AdsConfig.Interstitial_ID, AdsConfig.Interval)
            }
